...
namespace Animal.Controllers
{
    ...
    public class AnimalController : ControllerBase
    {
        ...
        {
            Entities.Animal createdAnimal = _repo.CreateEAnimal(createAnimalDTO);
        ...
        [HttpPut("{id}")]
        public IActionResult UpdateAnimal([FromBody] Entities.Animal animal, int id)
        {
            Entities.Animal updatedAnimal = _repo.UpdateEAnimal(animal, id);
            AnimalDTO animallDTO = MapAnimalToAnimallDTO(updatedAnimal);
            return Ok(animallDTO);
        }


        private AnimalDTO MapAnimalToAnimallDTO(Entities.Animal animal)
        {
